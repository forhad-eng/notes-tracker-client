...
export default function UpdateModal({ _id, handleUpdate }) {
    let subtitle
        ...
        <div>
            ...
            >
                ...
                <div className=" p-3 color-4D4C7D">
                    <form onSubmit={e => handleUpdate(e, _id)} className="container ">
                        ...
                        <div className="input-group">
                            <textarea className="form-control" name="note" aria-label="With textarea"></textarea>
                        </div>
                        <div className="mt-4">
